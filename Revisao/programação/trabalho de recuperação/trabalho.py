    ...
    #----------------- Executando a Regra de SE FORMAR ---------------------------------------------------           
        if j1casa == 5:
            ...
            if casadado == 1:
                ...
                print('Jogos Digitais')
                j1formou = 'Jogos Digitais'
                
            elif casadado == 4:
                print('Segurança de Informação')
    ...
    #----------------- Executando a Regra de MATEMATICA ---------------------------------------------------
        if j1casa == 4 or j1casa == 11 or j1casa == 19:
            ...
            if casadado ==1:
                ...
                print('A área de um circulo de raio 2,5')
                circulo= 3.142 * (2.5 * 2)
                ...
                print('5 primeiros n devisivel por 2 e 5')
